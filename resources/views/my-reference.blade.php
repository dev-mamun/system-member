...
<header class="d-flex justify-content-between py-3 px-3 pt-xl-4 px-xl-4">
    ...
    <div>
        <h1 class="text-uppercase text-light d-flex mb-0"><img src="{{ url('icon%20-%20member.png') }}" width="40"
                                                               height="40" class="me-2">MY REFERRALS</h1>
    </div>
    <div>
        ...
        <table class="table table-dark custom-table mb-0">
            ...
            @foreach($users as $key=>$user)
                @if(!is_null($user->fundusers))
                    $fundUserValue = $user->fundusers->value
