                ...
                <div class="card mx-auto card-login" style="max-width: 332px;">
                    ...
                    <div class="card-body pt-3 pb-4">
                        <form class="text-center mx-auto px-3" method="post">
                            ...
                            <!-- Start: Full Name -->
                            <div class="text-center input-icon position-relative mb-2"><img class="position-absolute" src="{{ url('icon%20-%20profile%20gray.png') }}"><input class="form-control" type="email" placeholder="FULL NAME"></div><!-- End: Full Name -->
                            <!-- Start: Email Address -->
                            <div class="text-center input-icon position-relative mb-2"><img class="position-absolute" src="{{ url('icon%20-%20mobile.png') }}"><input class="form-control" type="email" placeholder="MOBILE NO."></div><!-- End: Email Address -->
                            <!-- Start: Email Address -->
